...
print('За один ход мы можем взять от 1 до 28 конфет, ')
print('Побеждает тот, кто последним сделает свой ход и ему достанутся все конфеты!')
print('Итак, начнём!!!')
...
while candy_on_table > 0:
    if player_dict[player_num] != 'Конфетный БОТ':
        if hint == 1:
            print('Подсказка:')
